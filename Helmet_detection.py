...
# Draw a bounding box.
    ...
    print(label_name)
    if label_name == None:
          cv.putText(frame, "No Helmet", (0, 15), cv.FONT_HERSHEY_SIMPLEX, 0.75, (0,0,255), 1)
    else:
         cv.putText(frame, "Helmet", (0, 15), cv.FONT_HERSHEY_SIMPLEX, 0.75, (0,0,255), 1)
    if label_name == 'Helmet':
        ...
        cv.putText(frame, label_name, (0, 15), cv.FONT_HERSHEY_SIMPLEX, 0.75, (0,0,255), 1)
        frame_count+=1
